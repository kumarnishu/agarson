      ...
      {!isLoading && <ScrollView contentContainerStyle={{ flexDirection: 'column', gap: 10, alignItems: 'flex-start', padding: 10 }}>
        ...
        {visit && visit.start_day_credientials &&
          <>
            ...
            <Text style={{ textAlign: 'center', fontWeight: 'bold', width: '100%', padding: 5, fontSize: 15 }} >STARTED DAY AT : <Text style={{ color: 'black' }}>{new Date(visit?.start_day_credientials.timestamp).toLocaleTimeString()}</Text></Text>
